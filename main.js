...
function initSystemSlider() {
    ...
    const slides = [
            ...
            html: `
                <div class="calendar-mini">
                    ...
                    <div class="calendar-slots">
                        <div></div>
                        <div class="booking">09:00<br>Kunde A</div>
                        <div></div>
                        <div class="booking">12:30<br>Befaring</div>
                        <div></div>

                        <div class="booking">14:00<br>Service</div>
                        <div></div>
                        <div class="booking">15:15<br>Møte</div>
                        <div></div>
                        <div class="booking">10:00<br>Ny avtale</div>
                    </div>
                </div>
            `
        },
            ...
            html: `
                <div class="invoice-ui">
                    ...
                    <div class="invoice-line">
                        <span>#1042 · Kunde AS</span>
                        <strong>Sendt</strong>
                    </div>

                    <div class="invoice-line">
                        <span>#1043 · Nordbygg</span>
                        <strong>Utkast</strong>
                    </div>

                    <div class="invoice-summary">
                        <span>Betalt denne måneden</span>
                        <strong>38 400 kr</strong>
                    </div>
                </div>
            `
        },

        {
            ...
            html: `
                <div class="stamp-card">
                    <span>Inn i dag</span>
                    <strong class="stamp-time">07:58</strong>
                </div>
        ...
        {
            title: "Forespørsler",
            text: "Samle henvendelser og oppfølging på ett sted.",
            html: `
        ...
        {
            title: "Ansattportal",
            text: "Egne sider for ansatte, oppgaver og dokumenter.",
            html: `
                <div class="portal-header">
                    <div>
                        <strong>Hei, Martin</strong>
                        <span>Din oversikt i dag</span>
                    </div>
    ...
    function render() {
        ...
        dots.innerHTML = slides.map((_, i) =>
            `<button class="${i === index ? "active" : ""}"></button>`
        ).join("");
